...
import (
	...
	"gopkg.in/pivotal-cf-experimental/influxdb.v0/admin"
	"gopkg.in/pivotal-cf-experimental/influxdb.v0/api/collectd"
	"gopkg.in/pivotal-cf-experimental/influxdb.v0/api/graphite"
	"gopkg.in/pivotal-cf-experimental/influxdb.v0/api/http"
	"gopkg.in/pivotal-cf-experimental/influxdb.v0/api/udp"
